  ...
  <div className="content">
    <div className="wrapCareer">
      ...
      <div className="careerBox">
        ...
        <p>현대리바트</p>
        <p>
          미국 가구 브랜드 온라인 런칭 팀에 발령받아
          <span className="bold">미국 가구 브랜드 온라인 런칭</span>
          하고 <span className="bold">본사와 직접 커뮤니케이션</span>하면서 사이트 디자인과 퍼블리싱하면서 유지보수 진행했습니다.
        </p>
      </div>
      {/* <div className="adu">
        <p>2020.04 - 2020.10</p>
      ...
      <div className="careerBox">
        ...
        <p>
          IT 회사에서
          <span className="bold">온라인 방송, 펫 몰, 스트리밍 사이트 UI/UX 디자인</span>과 이벤트 프로모션 및 마케팅 배너 등 디자인 작업했습니다.
        </p>
      </div>
      <div className="careerBox">
        <p>2024.03 - 2025.03</p>
        <p>엔프로젝트</p>
        <p>
          엔프로젝트는 웹과 앱 개발을 하는 에이전시로 기획과 PM 역할을 했습니다. 주로 클라이언트 응대, 소통, 프로젝트 전반적인 조사와 기획, 일정관리, 업무 분배, 납품관리를 진행했습니다.
        </p>
      </div>
